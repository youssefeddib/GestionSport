...
<head>
    ...
    <title>SportFlow - Connexion</title>
...
<section class="hero">
    <div class="container">
        <h1 class="text-white fw-bold">Connectez-vous à <span class="text-warning">SPORTFLOW</span></h1>
        <p class="text-light lead">Accédez à votre compte en renseignant vos informations.</p>
